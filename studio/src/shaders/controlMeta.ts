...
export const TINTS: Record<ShaderId, Record<string, string>> = {
  ...
  bleed: {},
  silk: {
    streakWidth: 'streakTint',
    streakLen: 'streakTint',
    streakIntensity: 'streakTint',
    shimmer: 'streakTint',
    surfaceLine: 'surfaceColor',
  },
  web: {
...
const PER: Record<ShaderId, Record<string, string>> = {
  ...
  silk: {
    anchorCount: 'how many colour masses build the gradient',
    spread: 'how large each colour mass grows',
    softness: 'how much the masses melt into each other',
    warp: 'cloudy wander in the boundaries between colours',
    warpScale: 'size of the cloud detail',
    grain: 'film grain over the gradient',
    baseColor: 'canvas floor colour behind the masses',
    streakCount: 'number of light shafts',
    streakAngle: 'axis the light shafts run along',
    streakWidth: 'thickness of each shaft',
    streakLen: 'how far a shaft reaches before fading',
    streakIntensity: 'how brightly the shafts glow',
    streakTint: 'light shaft colour',
    fillLevel: 'where the gradient pools up to',
    boundarySoft: 'how gradually the pool dissolves at the waterline',
    surfaceLine: 'hairline drawn at the waterline',
    surfaceColor: 'waterline hairline colour',
    driftSpeed: 'how fast the colour masses drift',
    silkStatic: 'freeze all gradient motion',
  },
  web: {
    bg: 'background colour behind the web',
    webCount: 'number of nodes on the shell',
    webRadius: 'overall web size',
    webIrregularity: 'how far the shell deviates from a sphere',
    linksPerNode: 'lines leaving each node',
    nodeShape: 'node glyph shape',
    nodeSize: 'node dot size',
    nodeColor: 'node colour',
    lineWidth: 'line thickness',
    lineOpacity: 'line transparency',
    lineColor: 'line colour',
    perspective: 'camera depth exaggeration',
    depthFade: 'far side of the web fades',
    depthShrink: 'far side of the web shrinks',
    webDrag: 'drag moves the whole web instead of nodes',
    autoSpin: 'idle rotation speed',
